...
%
{A análise descrita em 3.2 trata cada lote individualmente, sem considerar quantas máquinas diferentes processaram o mesmo lote ao longo da operação. Esse fator é relevante porque, quando um lote causa rompimentos em máquinas distintas, a hipótese de matéria-prima como causa comum ganha sustentação relativa em relação à hipótese de falha localizada em uma máquina específica. Esta subseção descreve a métrica que captura esse padrão~\todocite{causa comum entre máquinas / contaminação cruzada de lote}.}
%
...
%
{As três técnicas descritas na Seção 3 operam sobre tabelas distintas e produzem sinais independentes. A arquitetura proposta combina esses sinais em um diagnóstico único por evento, preservando rastreabilidade da evidência que sustenta cada classificação~\todocite{rastreabilidade / explicabilidade em pipelines industriais de diagnóstico}.}
%
